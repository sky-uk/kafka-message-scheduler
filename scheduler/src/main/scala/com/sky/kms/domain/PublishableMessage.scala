...
object PublishableMessage {
  ...
  final case class ScheduledMessage(inputTopic: String,
                                    outputTopic: String,
                                    key: Array[Byte],
  ...
  final case class ScheduleDeletion(scheduleId: ScheduleId, scheduleTopic: String, headers: Map[String, Array[Byte]])
      extends PublishableMessage
